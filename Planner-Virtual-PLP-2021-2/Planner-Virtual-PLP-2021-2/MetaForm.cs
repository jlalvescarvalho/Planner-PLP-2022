    ...
    public partial class MetaForm : Form
    {
        ...
        private void SalvarMeta()
        {
            ...
            try {
                ...
                MessageBox.Show("Meta salva!", "Os dados foram salvos corretamente!", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void AtualizarMeta()
        {
            ...
            try
            {
                ...
                cmd.ExecuteNonQuery();
                conn.Close();
                MessageBox.Show("Meta atualizada!","Dados atualizados com sucesso.", MessageBoxButtons.OK, MessageBoxIcon.Information);
                this.Close();
